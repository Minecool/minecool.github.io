...
function ShuffleSeeded(seed) {
  const list = ['Alchemist', 'BananaFarm', 'BombShooter', 'BoomerangMonkey', 'DartMonkey', 'Druid', 'GlueGunner', 'HeliPilot', 'IceMonkey', 'MonkeyAce', 'MonkeyBuccaneer', 'MonkeySub', 'MonkeyVillage', 'NinjaMonkey', 'SniperMonkey', 'SpikeFactory', 'SuperMonkey', 'TackShooter', 'WizardMonkey', 'MortarMonkey', 'EngineerMonkey', 'DartlingGunner', 'BeastHandler'];
  currentSeed = seed;
